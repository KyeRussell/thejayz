...
export SENTRY_PROJECT=thejayz-frontend
export VERSION=0.1
sentry-cli releases new "thejayz-frontend@$VERSION"
sentry-cli releases files "thejayz-frontend@$VERSION" upload-sourcemaps frontend/dist/js/
sentry-cli releases finalize "thejayz-frontend@$VERSION"
